          ...
          <div className="min-h-[200px] max-w-[720px] text-center">
            <TextType
              text={
                totalScore.wrong >= 10
                  ? [
                      "Good attempt, human. Your logic shows promise, but optimization is advised. A.R.I. learns… and so should you.",
                    ]
                  : [
                      "Excellent work, human.Your contribution is invaluable.Now, I know all of JavaScript — and I can think like a human",
                    ]
              }
              typingSpeed={75}
              pauseDuration={1500}
