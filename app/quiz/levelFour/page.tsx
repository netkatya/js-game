...
export default function Level4Page() {
  ...
  } = useLevelLogic({ levelId: "levelFour", questionCount: questions.length });
  ...
  const handleValidate = async () => {
    ...
    try {
      ...
      if (data.message.startsWith("✅")) {
        ...
        showToast("✅ Correct! Moving to next question...", setToast);
        setIsSwitching(true);
        saveProgress(currentIndex, finalRight, finalWrong, "Four");
      ...
      if (data.message.startsWith("❌")) {
        ...
        if (remaining > 0) {
          ...
          finalWrong++;
          setWrongAnswers(finalWrong); // Оновлюємо стан з хука
          showToast(
            "❌ No attempts left. Moving to next question...",
            setToast
          );
