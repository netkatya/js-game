export default function Levels() {
  return (
    <section className="pt-[40px] pb-[40px] flex justify-center">
      <div className="pl-[20px] pr-[20px] max-w-[1200px]">
        <ul className="flex flex-col gap-[40px]">
          <li className="flex gap-[24px]">
            {/* <Image></Image> */}
            <div className="flex flex-col gap-[8px]">
              <p className="text-xl font-bold">Type: Test</p>
          ...
          <li className="flex gap-[24px]">
            <div className="flex flex-col gap-[8px]">
              <p className="text-xl font-bold">Type: Text Input</p>
              <p className="text-xl font-bold">
                Description:{" "}
                <span className="text-xl font-normal">
          ...
          <li className="flex gap-[24px]">
            {/* <Image></Image> */}
            <div className="flex flex-col gap-[8px]">
              <p className="text-xl font-bold">Type: Live Code</p>
              <p className="text-xl font-bold">
                Description:{" "}
                <span className="text-xl font-normal">
          ...
          <li className="flex gap-[24px]">
            {/* <Image></Image> */}
            <div className="flex flex-col gap-[8px]">
              <p className="text-xl font-bold">Type: Debugging</p>
              <p className="text-xl font-bold">
                Description:{" "}
                <span className="text-xl font-normal">
