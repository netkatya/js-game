  ...
  return (
    <div className="p-[40px] flex justify-center">
      <div className="bg-[#079cde] max-w-[1127px] p-[34px] flex gap-[40px] rounded-[40px]">
        <div className="max-w-[540px] flex flex-col gap-[24px] justify-center items-center">
          <h2 className="font-semibold text-4xl text-center text-black max-w-[350px]">
          ...
          <div className="p-[16px] border border-black">
            <p className="font-semibold text-2xl text-center text-black">
              ...
              artificial instructor — A.R.I. (Artificial Robotic Instructor).
              Its mission is to teach people coding faster than any human could.
            </p>
          </div>
          <p className="font-semibold text-2xl text-center text-black">
          ...
          <p className="font-semibold text-2xl text-center text-black italic">
